        ...
        <div class="container d-flex align-items-center">
            ...
            <nav class="main-nav d-none d-lg-block">
                <ul>
                    ...
                    <li class="active"><a href="">Info Audience</a></li>
        ...
        <div class="container d-flex h-100">
            <div class="row justify-content-center align-self-center" data-aos="fade-up">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <h2 class="my-3">Daftar Audience</h2>
                            <hr>
                            <form action="/audience/save" method="post" enctype="multipart/form-data">
                                <?= csrf_field(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control <?= ($validation->hasError('pekerjaan')) ?
                                                                                    'is-invalid' : ''; ?>" id="pekerjaan" name="pekerjaan" autofocus value="<?= old('pekerjaan'); ?>">
